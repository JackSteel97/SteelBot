...
public class PuzzleSixteen : IQuestion
{
    private const int _number = 16;
    private const string _puzzleFile = "ATastyTreat.txt";
    private const string _clueText = "Hash brown";
    private const string _answerText = "unsecure";
