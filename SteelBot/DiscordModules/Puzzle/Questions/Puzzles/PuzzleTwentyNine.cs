...
public class PuzzleTwentyNine : IQuestion
{
    private const int _number = 29;
    private const string _puzzleFile = "Ooer.png";
    private const string _clueText = "`2020-11-22` - `2020-12-12`";
