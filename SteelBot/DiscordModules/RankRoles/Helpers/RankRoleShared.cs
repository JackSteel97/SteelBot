...
public static class RankRoleShared
{
    ...
    public static async ValueTask UserLevelledUp(ulong guildId, ulong userId, DiscordGuild guild, RankRolesProvider rankRolesProvider, UsersProvider usersProvider, LevelMessageSender levelMessageSender)
    {
